KTH Changes
===========
- Base branch is hydro-devel to mimic what we have on the PR2
- Before running pr2_calibration, compile this package using ```catkin_make_isolated```. Do not forget to wget the ```package.xml``` (see below).
